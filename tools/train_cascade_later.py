...
parser.add_argument("--ckpt", type=str,                     default=None, # '/raid/meng/Pointcloud_Detection/PointRCNN_weak/output/rcnn/eval1000/ckpt/checkpoint_iter_8010.pth',
                    help="continue training from this checkpoint")
parser.add_argument("--pretrain_ckpt", type=str,            default=
'/raid/meng/Pointcloud_Detection/PointRCNN5.1_weak/output/rcnn/536.2_fulldata3000_s3264x1.00_40000/ckpt/checkpoint_iter_39976.pth',
#'/raid/meng/Pointcloud_Detection/PointRCNN3.1_weak/output/ioun/301_cascade2_s500x0.25_10000/ckpt/checkpoint_iter_09945.pth',
                    help="continue training from this checkpoint")

parser.add_argument("--noise_kind", type=str,               default=None,
                    help='specify noise mode for label')
parser.add_argument("--weakly_scene", type=int,               default=3264,
                    help='specify noise mode for label')
parser.add_argument("--weakly_ratio", type=float,               default=1.0,
                    help='specify noise mode for label')
args = parser.parse_args()
exp_id = '536.2_full3000_536.2_fulldata3000' + '_s%dx%.2f'%(args.weakly_scene, args.weakly_ratio) + '_%d'%args.total_iters
#exp_id = '105_135_d03s01_corner_gttrans0.1g_36581_backcls' + '_s%dx%.2f'%(args.weakly_scene, args.weakly_ratio) + '_%d'%args.total_iters
