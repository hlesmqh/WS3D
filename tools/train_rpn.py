...
parser.add_argument("--total_iters", type=int,              default=8000,
...
parser.add_argument("--pretrain_ckpt", type=str,            default=None,                     help="continue training from this checkpoint")

parser.add_argument("--noise_kind", type=str,               default='label_noise',
                    help='specify noise mode for label')
parser.add_argument("--weakly_num", type=int,               default=500,
                    help='specify noise mode for label')
...
if __name__ == "__main__":
    ...
    root_result_dir = os.path.join('../', 'output', 'rpn', cfg.TAG + exp_id)
