...
__C.RPN.Gaussian_Center = True
__C.RPN.GAUSS_HEIGHT = 0.707
__C.RPN.GAUSS_STATUS = 0.7
__C.RPN.GAUSS_COV = 1.5
...
__C.RCNN.GT_GUIDE_CENTER_FEATURE = False
...
__C.RCNN.CLS_BG_THRESH = 1.0
__C.RCNN.CLS_BG_THRESH_LO = 2.0
...
# 2. config of rcnn network
__C.IOUN = edict()
__C.IOUN.ENABLED = False

# config of input

__C.IOUN.USE_RPN_FEATURES = True
__C.IOUN.USE_MASK = True
__C.IOUN.MASK_TYPE = 'seg'
__C.IOUN.USE_INTENSITY = False
__C.IOUN.USE_DEPTH = True
__C.IOUN.USE_SEG_SCORE = False
__C.IOUN.ROI_SAMPLE_JIT = False
__C.IOUN.GT_GUIDE_CENTER_FEATURE = False
__C.IOUN.ROI_FG_AUG_TIMES = 10

__C.IOUN.REG_AUG_METHOD = 'multiple'  # multiple, single, normal
__C.IOUN.POOL_EXTRA_WIDTH = 1.0

# config of bin-based loss
__C.IOUN.LOC_SCOPE = 1.5
__C.IOUN.LOC_BIN_SIZE = 0.5
__C.IOUN.NUM_HEAD_BIN = 9
__C.IOUN.LOC_XZ_FINE = False
__C.IOUN.LOC_Y_BY_BIN = False
__C.IOUN.LOC_Y_SCOPE = 0.5
__C.IOUN.LOC_Y_BIN_SIZE = 0.25
__C.IOUN.SIZE_RES_ON_ROI = False
__C.IOUN.NUM_CENTER_SAMPLE = 128

# config of network structure
__C.IOUN.USE_BN = False
__C.IOUN.DP_RATIO = 0.0

__C.IOUN.BACKBONE = 'pointnet'  # pointnet, pointsift
__C.IOUN.XYZ_UP_LAYER = [128, 128]

__C.IOUN.NUM_POINTS = 512
__C.IOUN.SA_CONFIG = edict()
__C.IOUN.SA_CONFIG.NPOINTS = [128, 32, -1]
__C.IOUN.SA_CONFIG.RADIUS = [0.2, 0.4, 100]
__C.IOUN.SA_CONFIG.NSAMPLE = [64, 64, 64]
__C.IOUN.SA_CONFIG.MLPS = [[128, 128, 128],
                           [128, 128, 256],
                           [256, 256, 512]]
__C.IOUN.CLS_FC = [256, 256]
__C.IOUN.REG_FC = [256, 256]

# config of training
__C.IOUN.LOSS_CLS = 'BinaryCrossEntropy'
__C.IOUN.FOCAL_ALPHA = [0.25, 0.75]
__C.IOUN.FOCAL_GAMMA = 2.0
__C.IOUN.CLS_WEIGHT = np.array([1.0, 1.0, 1.0], dtype=np.float32)
__C.IOUN.CLS_FG_THRESH = 0.6
__C.IOUN.CLS_BG_THRESH = 1.0
__C.IOUN.CLS_BG_THRESH_LO = 2.0
__C.IOUN.REG_FG_THRESH = 0.55
__C.IOUN.FG_RATIO = 0.5
__C.IOUN.ROI_PER_IMAGE = 64
__C.IOUN.HARD_BG_RATIO = 0.6
__C.IOUN.SCORE_THRESH = 0.5
